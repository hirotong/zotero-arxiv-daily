...
def get_block_html(
    ...
    <tr>
        <td style="font-size: 20px; font-weight: bold; color: #333;">
            <a href=\"{abs_url}\" style=\"color: #333; text-decoration: none;\">{title}</a>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td style="padding: 8px 0;">
            <a href="{abs_url}" style="display: inline-block; text-decoration: none; font-size: 14px; font-weight: bold; color: #fff; background-color: #28a745; padding: 8px 16px; border-radius: 4px; margin-left: 8px;">Abstract</a>
